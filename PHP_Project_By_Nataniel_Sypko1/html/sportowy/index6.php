        ...
        <nav class="navbar">
            ...
            <div class="list">
                    <ul>
                        ...
                        <li class="active"><a href="../sportowy/index2.html"><i class="fa-solid fa-volleyball"></i> Sportowy(wpisz)</a></li>
            ...
            <div class="listic">
                <ul>
                    ...
                    <li class="active"><a href="../sportowy/index2.html"><i class="fa-solid fa-volleyball"></i></a></li>
