        ...
        <nav class="navbar">
            <div class="menu">
                <div class="list">
                    <ul>
                        ...
                        <li class="../active"><a href="spozywczy/index3.html"><i class="fa-solid fa-bread-slice"></i> Spożywczak(wpisz)</a></li>
            ...
            <div class="listic">
                <ul >
                    ...
                    <li class="active"><a href="../spozywczy/index3.html"><i class="fa-solid fa-bread-slice"></i></a></li>
